...
class SortItem(Generic[SortKeyT, ValueT]):
    ...
    def __init__(self, key: SortKeyT, dir: SortDir, before: Optional[ValueT], after: Optional[ValueT]) -> None:
        super().__init__()
        self.key = key
        self.dir = dir
        self.before = before
    ...
    def equal_filter(self) -> Optional[FilterItem[ValueT]]:
        ...
        """
        return FilterItem[self.__valuet__()](
            operator=StandardOperator.EQUAL,
            value=self.after
        )
    ...
    def not_equal_filter(self) -> Optional[FilterItem[ValueT]]:
        ...
        return FilterItem[self.__valuet__()](
            operator=StandardOperator.NOT_EQUAL,
            value=self.after
        )
